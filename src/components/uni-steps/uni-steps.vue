...
<!-- 					<view :style="{color:index==active?activeColor:deactiveColor}" :class="[direction==='column'?'uni-steps__column-time':'uni-steps__row-time']">
						<view>{{item.data}}</view>
						<view>{{item.time}}</view>
					</view> -->
					...
					<text :style="{color:index==active?activeColor:deactiveColor}" :class="[direction==='column'?'uni-steps__column-desc':'uni-steps__row-desc']">{{item.data}}  {{item.time}}</text>
